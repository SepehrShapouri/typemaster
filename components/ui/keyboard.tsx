...
export function Keyboard({
  ...
  return (
    <KeyboardProvider
      ...
      targetKey={targetKey}
      capturePhysicalInput={capturePhysicalInput}
      soundUrl={soundUrl}
    ...
    >
      <div
        ...
        role="group"
        aria-label="Interactive QWERTY keyboard"
      >
        <KeyboardLayout />
      </div>
    </KeyboardProvider>
...
function KeyboardProvider({
  ...
  useEffect(() => {
    if (!isVisible && !capturePhysicalInput) {
      return;
    }
  ...
  }, [capturePhysicalInput, isVisible, pressKey, releaseKey]);
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: isTarget
            ? "0 0 0 3px #dff56d, 0 0 22px rgba(223, 245, 109, 0.7)"
            : undefined,
        }}
      >
        <div
...
function isKnownKeyCode(code: string) {
  return Object.values(KEYCODE).includes(code as KEYCODE);
}
